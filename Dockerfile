...
COPY src /usr/src/nsid/
WORKDIR /usr/src/nsid
...
RUN chmod +x /usr/src/nsid/tasks.py \
    && chmod +x /usr/src/nsid/entrypoint.sh
...
# ENTRYPOINT /usr/src/nsid/entrypoint.sh
